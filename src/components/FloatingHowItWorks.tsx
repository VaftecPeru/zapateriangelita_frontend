...
const FloatingHowItWorks = () => {
    ...
    return (
        <div className="fixed bottom-8 right-8 z-[9999] flex flex-col items-end gap-3 pointer-events-none">
            <div className={`
                bg-minimal-olive text-white px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest 
            ...
            <div className="flex items-center gap-2 pointer-events-auto group">
                <Link
                    ...
                    className="
                        bg-minimal-olive text-white h-14 w-14 rounded-full flex items-center justify-center 
                    ...
                    "
                >
                    <div className="absolute inset-0 bg-minimal-gold scale-0 group-hover:scale-100 transition-transform duration-500 rounded-full origin-center"></div>
                ...
                <Link
                    to="/how-it-works"
                    className="
                        hidden md:flex bg-white border border-minimal-olive px-6 py-3 rounded-full 
                        text-[11px] font-black uppercase tracking-widest shadow-xl
                        hover:bg-minimal-olive hover:text-white transition-all duration-300
                    "
                >
