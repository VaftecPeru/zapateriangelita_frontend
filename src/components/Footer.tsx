...
const Footer = () => {
    ...
    return (
        <footer id="contacto" className="bg-black text-white pt-20 pb-12 px-6">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-12 mb-16 px-4 md:px-0">
                    <div className="col-span-2 lg:col-span-1 flex flex-col items-start text-left space-y-6">
                        <div className="flex items-center gap-2">
                            <div className="w-9 h-9 bg-white rounded-xl flex items-center justify-center text-black font-bold text-lg">U</div>
                            <span className="text-white font-black text-2xl tracking-tighter">Umbral Suites</span>
                        </div>
                    ...
                    <div className="flex flex-col items-start text-left">
                        <h4 className="text-[10px] font-black text-white/40 uppercase tracking-[0.2em] mb-8">Enlaces Rápidos</h4>
                        <ul className="space-y-4">
                            {[
                                { label: "Propiedades", path: "/#apartamentos" },
                                { label: "Preguntas frecuentes", path: "/faq" }
                            ].map(item => (
                                <li key={item.label} className="text-white/60 hover:text-white active:scale-95 transition-all w-fit cursor-pointer text-sm font-bold">
                    ...
                    <div className="flex flex-col items-start text-left">
                        <h4 className="text-[10px] font-black text-white/40 uppercase tracking-[0.2em] mb-8">Empresa</h4>
                        <ul className="space-y-4">
                            {[
                                { label: "Sobre nosotros", path: "/about" }
                            ].map(item => (
                                <li key={item.label} className="text-white/60 hover:text-white cursor-pointer transition-colors w-fit text-sm font-bold">
                                    <Link to={item.path}>{item.label}</Link>
                                </li>
                            ))}
                        </ul>
                    ...
                    <div className="flex flex-col items-start text-left">
                        <h4 className="text-[10px] font-black text-white/40 uppercase tracking-[0.2em] mb-8">Contacto</h4>
                        <ul className="space-y-5">
                            <li className="flex items-start gap-3 text-white/60 text-sm font-bold">
                ...
                <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-8">
                    ...
                    <div className="flex gap-8">
                        <Link to="/terms" className="text-white/40 text-[13px] font-bold hover:text-white cursor-pointer transition-colors">Términos</Link>
                        <Link to="/privacy" className="text-white/40 text-[13px] font-bold hover:text-white cursor-pointer transition-colors">Privacidad</Link>
                        <span className="text-white/40 text-[13px] font-bold hover:text-white cursor-pointer transition-colors">Cookies</span>
                    </div>
                </div>
            </div>
        </footer>
