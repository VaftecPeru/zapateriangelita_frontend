...
import { X, Bed, Bath, Square, MapPin, Star, CheckCircle2, Users, User, Phone, Wifi, Car, Tv, Droplets, Dumbbell, Coffee, Wind, Utensils, Shield, Sun, PawPrint, Home, Laptop, ArrowUpCircle } from 'lucide-react';
...
const PropertyDetails: React.FC<PropertyDetailsProps> = ({ property, onClose }) => {
    ...
    const [errors, setErrors] = useState<{firstName?: string, lastName?: string, phone?: string, checkIn?: string, checkOut?: string}>({});
    ...
    // Build the complete image list: cover image first, then additional images, deduped, max 5
        ...
        <div className="fixed inset-0 z-[2000] bg-minimal-beige overflow-y-auto font-inter">
                    ...
                    {images.length === 0 ? (
                        ...
                        <>
                            <div 
                                ...
                                style={{ height: '45vw', minHeight: '260px' }}
                        ...
                        <div className="bg-white border border-black rounded-2xl p-8">
                            <div className="flex flex-col gap-2 mb-6">
                                {property.discounted_price && Number(property.discounted_price) > 0 ? (
                                    ...
                                    <span className="text-4xl font-black text-black">S/{Number(property.price).toFixed(2)}</span>
                                )}
                                <span className="text-black font-bold text-sm">por mes</span>
                            </div>
                            ...
                            <form className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="flex flex-col gap-2">
                                        <label className="text-[11px] text-gray-400 font-black uppercase tracking-widest pl-1">Nombre</label>
                                    ...
                                    <div className="flex flex-col gap-2">
                                        <label className="text-[11px] text-gray-400 font-black uppercase tracking-widest pl-1">Apellidos</label>
                                        <div className="relative group">
                                            <User className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-black transition-colors" size={18} />
                                            <input
                                                type="text"
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="flex flex-col gap-2">
                                        <label className="text-[11px] text-gray-400 font-black uppercase tracking-widest pl-1">Celular</label>
                                        <div className="relative group">
                                ...
                                <p className="text-[10px] text-black text-center font-bold uppercase tracking-widest">
            ...
            {lightboxIndex !== null && (
                ...
                >
                    ...
                    <div className="absolute top-6 left-1/2 -translate-x-1/2 text-white/60 text-xs font-bold tracking-widest">
